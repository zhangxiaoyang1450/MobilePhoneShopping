    ...
    <div class="wrapper">
        ...
        <div id="search-contain">
            <div class="search-input">
                <form action="firstmain.php" method="post">
    ...
    <div class="wrapper">
        <ul>
            ...
            <li class="brand-type brand1">
                <a href="shop.php?phone_id=<?php echo $phone_id=$result_arr['phone_id'];?>" >
...
<!--                <a style="color: white">回到顶部 </a>-->
            ...
            <li>
                <form action="firstmain.php?username=<?php echo $username?>" method="post">
                    <button name="phone_text" value="">全部</button>
            </li>
            <li>
                <form action="firstmain.php" method="post">
