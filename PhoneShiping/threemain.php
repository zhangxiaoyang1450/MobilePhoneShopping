...
<div id="header">
    <div class="wrapper">
        <P id="login-contain">
            嗨，初级管理员:<?php echo $username = $_GET['username']?>，欢迎来到正阳手机销售
        ...
        <ul id="header-menu">
            <li class="menu menu-hd">
                <a href="./data2/allusers.php?" target="_blank">用户管理</a>
            </li>
            <li class="menu menu-hd">
                <a href="">管理员权限</a>
                <ul class="sub-menu">
                    <li>
                        <a href="register2.html" target="_blank">普通用户注册</a>
                    </li>
                    <li>
                        <a href="car2.php" target="_blank">购物车管理</a>
                    </li>
                    <li>
                        <a href="./shopdata/allshop.php" target="_blank">管理商品</a>
                    </li>
                </ul>
            </li>
            <li class="menu menu-hd">
    ...
    <div class="wrapper">
        ...
        <div id="search-contain">
            <div class="search-input">
                <form action="threemain.php" method="post">
            ...
            <ul class="search-list">
                <li class="first">
                    <form action="twomain.php?username=<?php echo $username?>" method="post">
                ...
                <li>
                    <form action="threemain.php?username=<?php echo $username?>" method="post">
        ...
        <ul>
            <?php for($i=0; $i<$dataCount; $i++):
                ...
                <li class="brand-type brand1">
                    <a href="shop.php?username=<?php echo $username?>&phone_id=<?php echo $phone_id=$result_arr['phone_id'];?>" target="_blank">
