...
<div id="header">
    <div class="wrapper">
        <P id="login-contain">
            嗨，超级管理员:<?php echo $username = $_GET['username']?>，欢迎来到正阳手机销售
            <a href="homepage.html"></a>
            <a href="register2.html">免费注册</a>
        </P>
        <ul id="header-menu">
            <li class="menu menu-hd">
                <a href="./data1/allusers.php" target="_blank">用户管理</a>
            </li>
            <li class="menu menu-hd">
                <a href="">超级管理员权限</a>
                <ul class="sub-menu">
                    <li>
                        <a href="register3.html" target="_blank">管理员注册</a>
                    </li>
                    <li>
    ...
    <div class="wrapper">
        ...
        <div id="search-contain">
            <div class="search-input">
                <form action="twomain.php" method="post">
